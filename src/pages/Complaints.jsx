          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
            ...
            <div className="bg-orange-50 border border-orange-100 rounded-xl p-4">
              ...
              <p className="text-2xl font-bold text-orange-600">
                {complaints.length > 0
                  ? ((resolvedComplaints / complaints.length) * 100).toFixed(0)
                  : 0}%
              </p>
            </div>
          </div>
          ...
          <div className="hidden md:block bg-white rounded-xl shadow-sm overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {complaints.length === 0 ? (
                  <tr>
                    <td colSpan={7} className="p-8 text-center text-gray-400">No complaints yet</td>
                  </tr>
                ) : (
                  complaints.map((item) => (
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
              ...
              <p className="text-lg font-bold text-blue-600">
                {platformData.length > 0
                  ? platformData.sort((a, b) => b.count - a.count)[0].name
                  : "—"}
              </p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              {activeTab === "complaints" ? (
                <>
                  ...
                  />
                  <select
                    value={complaintForm.salesPerson}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-xl p-6 w-80">
            ...
            <div className="flex gap-3">
              <button
                onClick={() => { setDeleteId(null); setDeleteType(""); }}
